...
//  Need to take out.  Testing is over and feature not implemented
...
//namespace DropMore
//{
//    internal class AutoPickupPatchMain
//    {
...
//                .Where(i => DropMoreLootMain.categories.Contains(i.m_itemData.m_shared.m_itemType))
...
//                {
//                    var blockedItemNames = DropMoreLootMain.AutoPickupBlockList.Value.Split(';');
...
//            static void Postfix()
//            {
//                DropMoreLootMain.AutoPickupBlockList.Value = GetFilteredItemList()
...
//                {
//                    DropMoreLootMain.Destroy(trophy);
//                }
...
//                {
//                    GameObject gameObject = DropMoreLootMain.Instantiate(elementPrefab, itemListRoot);
